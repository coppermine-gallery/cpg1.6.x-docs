...
doc_toc += '        <ul>\n';
doc_toc += '          <li><a href="upgrading.htm#upgrade_10">Upgrading from version cpg1.0, cpg1.1, cpg1.2.x, cpg1.3.x or cpg1.4.x to cpg1.6.x</a></li>\n';
doc_toc += '          <li><a href="upgrading.htm#upgrade_14">Upgrading from cpg1.5.x to version cpg1.6.x</a>\n';
doc_toc += '              <ul>\n';
...
doc_toc += '              </ul>\n';
doc_toc += '          <li><a href="upgrading.htm#upgrade_15">Upgrading from older versions of cpg1.6.x to the most recent version of cpg1.6.x</a></li>\n';
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
...
doc_toc += '      <li><a href="upgrading.htm#downgrading">Downgrading from cpg1.6.x to an older version</a></li>\n';
doc_toc += '    </ul>\n';
doc_toc += '  </li>\n';
...
doc_toc += '        <ul>\n';
doc_toc += '          <li><a href="theme_upgrade.htm">Converting cpg1.5.x themes to cpg1.6.x</a>\n';
doc_toc += '            <ul>\n';
doc_toc += '              <li><a href="theme_upgrade.htm#theme_convert_style">Edit style.css</a></li>\n';
doc_toc += '              <li><a href="theme_upgrade.htm#theme_convert_template">Edit template.html</a></li>\n';
doc_toc += '              <li><a href="theme_upgrade.htm#theme_convert_theme">Edit theme.php</a></li>\n';
doc_toc += '              <li><a href="theme_upgrade.htm#theme_convert_validation">Validation Methodology</a></li>\n';
doc_toc += '            </ul>\n';
doc_toc += '          </li>\n';
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
...
doc_toc += '            <ul>\n';
doc_toc += '              <li><a href="dev_package.htm#packaging_steps_git_pull">Pull</a></li>\n';
...
doc_toc += '              <li><a href="dev_package.htm#packaging_steps_versioncheck">Update the versioncheck data</a></li>\n';
doc_toc += '              <li><a href="dev_package.htm#packaging_steps_git_push">Push your changes</a></li>\n';
doc_toc += '              <li><a href="dev_package.htm#packaging_steps_git_merge">Merge branches</a></li>\n';
doc_toc += '              <li><a href="dev_package.htm#packaging_steps_create_release">Create a release at GitHub.com</a></li>\n';
doc_toc += '              <li><a href="dev_package.htm#packaging_steps_git_clone">Clone master to fresh local directory</a></li>\n';
...
doc_toc += '              <li><a href="dev_package.htm#packaging_steps_xml_webspace">Update cpg16x.files.xml on the Coppermine home page</a></li>\n';
...
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
doc_toc += '      <li><a href="dev_git.htm">Git</a>\n';
doc_toc += '        <ul>\n';
doc_toc += '          <li><a href="dev_git.htm#dev_git_target_audience">Target audience</a></li>\n';
doc_toc += '          <li><a href="dev_git.htm#dev_git_caveat">Caveats</a></li>\n';
...
doc_toc += '              <li><a href="dev_git.htm#dev_git_repository_structure_plugins">Plugins</a></li>\n';
doc_toc += '            </ul>\n';
doc_toc += '          </li>\n';
doc_toc += '          <li><a href="dev_git.htm#dev_git_checking_out">Checking out</a>\n';
doc_toc += '            <ul>\n';
doc_toc += '              <li><a href="dev_git.htm#dev_git_checking_out_entire">Checking out the entire repository</a></li>\n';
doc_toc += '              <li><a href="dev_git.htm#dev_git_checking_out_particular_package">Checking out a particular Package</a></li>\n';
doc_toc += '              <li><a href="dev_git.htm#dev_git_checking_out_particular_file">Checking out a particular file</a></li>\n';
doc_toc += '              <li><a href="dev_git.htm#dev_git_checking_out_refering">Refering to files downloaded from the Git repository</a></li>\n';
doc_toc += '            </ul>\n';
doc_toc += '          </li>\n';
doc_toc += '          <li><a href="dev_git.htm#dev_git_download">Is there no single package that I could download instead?</a>\n';
doc_toc += '            <ul>\n';
doc_toc += '              <li><a href="dev_git.htm#dev_git_download_tarball">Download Tarball archives</a></li>\n';
doc_toc += '            </ul>\n';
doc_toc += '          </li>\n';
doc_toc += '          <li><a href="dev_git.htm#dev_git_dev-only">Developers-only</a>\n';
doc_toc += '            <ul>\n';
doc_toc += '              <li><a href="dev_git.htm#dev_git_checkout_checkin">Check out before checking in</a></li>\n';
doc_toc += '              <li><a href="dev_git.htm#dev_git_commit">Committing your code</a></li>\n';
doc_toc += '              <li><a href="dev_git.htm#dev_git_changelog">Changelog</a></li>\n';
doc_toc += '              <li><a href="dev_git.htm#dev_git_write_access">Obtaining write access</a></li>\n';
doc_toc += '            </ul>\n';
doc_toc += '          </li>\n';
doc_toc += '          <li><a href="dev_git.htm#dev_git_step-by-step">Step by step</a>\n';
doc_toc += '            <ul>\n';
doc_toc += '              <li><a href="dev_git.htm#dev_git_client-download">Download the client application</a></li>\n';
doc_toc += '              <li><a href="dev_git.htm#dev_git_initial_checkout">Initial checkout</a></li>\n';
doc_toc += '            </ul>\n';
doc_toc += '          </li>\n';
doc_toc += '          <li><a href="dev_git.htm#dev_git_revision">Revisions</a></li>\n';
doc_toc += '          <li><a href="dev_git.htm#dev_git_fileheaders">Git file headers</a></li>\n';
doc_toc += '        </ul>\n';
doc_toc += '      </li>\n';
...
function dateRevision() {
	...
	lastChangeDate = lastChangeDate.replace('$', '');
	lastChangeDate = lastChangeDate.replace('$', '');
	lastChangeDate = lastChangeDate.replace('LastChangedDate: ', '');
	lastChangeDate = lastChangeDate.replace(/Date: /g, '');
